...
format: 
  html:
    css: D:/repositories/liss_ef_2024/assets/style.css
...
pagedown::chrome_print(input = "preregistration/README.html", output = "preregistration/preregistration.pdf")
```


[click here to download a pdf version](https://github.com/Schecher1/Minecraft-Server-Creator/blob/master/README.md)
...
The dependent measures will be part of a new data collection in the LISS panel which is scheduled between May 2024 and July 2024.
