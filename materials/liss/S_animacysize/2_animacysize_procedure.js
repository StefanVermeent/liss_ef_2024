...
var animacysize_procedure01 = {
  ...
  timeline_variables: [
   ...
   {stim: 'matras',    key_answer: 'L', data: {rule: 'size', type: 'switch', variable: 'test', task: 'animacysize'}},
...
var animacysize_procedure02 = {
  ...
  timeline_variables: [
    ...
    {stim: 'kuiken',   key_answer: 'A', data: {rule: 'size', type: 'repeat', variable: 'test', task: 'animacysize'}},
